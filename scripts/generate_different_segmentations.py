...
scenarios = [
    ...
    {
        "db_prefix": "case1_high_low_engagement",
        "profiles": [
    ...
    {
        "db_prefix": "case2_price_vs_loyalty",
        "profiles": [
    ...
    {
        "db_prefix": "case3_cluster_outlier",
        "profiles": [
    ...
    {
        "db_prefix": "case5_conversion_ready",
        "profiles": [
...
if __name__ == "__main__":
    ...
    for scenario in scenarios:
        for algo in clustering_algos:
            filename = f"{algo_prefix[algo]}_{scenario['db_prefix']}.db"
        ...
        filename_gt = f"gt_{scenario['db_prefix']}.db"
